        ...
        <div className="bg-gradient-to-r from-gray-800 via-gray-900 to-black rounded-2xl shadow-xl p-8 md:p-12 border border-gray-500">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl font-bold mb-4 text-white">
              Beneficios de Nuestro Servicio de Tracking
            </h2>
            <p className="text-gray-400 mb-8">
              Nuestro sistema de seguimiento está diseñado para brindarte
              tranquilidad, eficiencia y transparencia en todo momento.
            </p>
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400">
                  Accede a actualizaciones precisas de la ubicación de tus
                  paquetes.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-400">
                  Recibe alertas automáticas sobre el progreso y entrega de tus
                  envíos.
                </p>
              </div>
            </div>
            <div className="text-center mt-8">
              <a
                ...
                className="inline-block px-3 py-1.5 text-xs bg-gradient-to-r from-gray-800 to-gray-500 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-[#D4AF37]/30 transition-all duration-300 sm:px-6 sm:py-2 sm:text-sm"
              >
                Descubre más
              </a>
            </div>
